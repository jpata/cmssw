...
#doesn't actually work, since the dataset is not located at CERN and xrootd fails
workflows[1370] = ['', ['QCD_FlatPt_15_3000HS_13INPUT_DIGIRAW','RECOUP17','HARVESTUP17']]
